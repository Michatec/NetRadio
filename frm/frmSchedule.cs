...
public partial class FrmSchedule : Form
{
    ...
    internal CheckBox RepeatActionsDaily
    {
        ...
        set => cbRepeatActionsDaily = value;
    }
    ...
    {
        var items = new ListViewItem[aLV.Items.Count]; // Liste der ListViewItems erstellen, um die Sortierung durchzuführen
    ...
    private void BtnEdit_Click(object sender, EventArgs e)
    {
        if (aLV.SelectedItems.Count > 0)
        {
            ...
            var s = aLV.SelectedItems[0].SubItems[1].Text;
            ...
            foreach (var station in stations) { frmTask.CmBxStations.Items.Add(station); }
    ...
    private void BtnDelete_Click(object sender, EventArgs e)
    {
        if (aLV.SelectedItems.Count > 0)
        {
            var x = aLV.SelectedItems[0].Index;
